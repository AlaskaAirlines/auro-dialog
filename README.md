...
<auro-dialog id="defaultDialog">
  <auro-button slot="trigger" id="openBasic">Open default dialog</auro-button>
  ...
  <div slot="footer">
    <auro-button secondary onclick="document.querySelector('#defaultDialog').closeDialog()">Close</auro-button>
  </div>
</auro-dialog>
```
<!-- AURO-GENERATED-CONTENT:END -->
...
<script src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-dialog@3.1.5/dist/auro-dialog__bundled.js" type="module"></script>
```
