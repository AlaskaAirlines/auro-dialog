...
<pre class="language-javascript"><code class="language-javascript">function toggleDialog(dialogID) {
...
<pre class="language-javascript"><code class="language-javascript">&lt;auro-button onClick="toggleDialog('#demo1')"&gt;Open Default Dialog&lt;/auro-button&gt;</code></pre>
...
<pre class="language-javascript"><code class="language-javascript">&lt;auro-dialog id="[unique ID]"&gt;
...
<pre class="language-js"><code class="language-js">export function initBasicExample() {
